...
async def activevc(_, message: Message):
    ...
    for x in served_chats:
        try:
            title = (await Hiroko.get_chat(x)).title
        except:
        ...
        try:
            ...
            continue
    if not text:
        await mystic.edit_text(f"» ɴᴏ ᴀᴄᴛɪᴠᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛs ᴏɴ {Hiroko.mention}.")
    else:
...
async def activevi_(_, message: Message):
    ...
    for x in served_chats:
        ...
        try:
            ...
            continue
    if not text:
        await mystic.edit_text(f"» ɴᴏ ᴀᴄᴛɪᴠᴇ ᴠɪᴅᴇᴏ ᴄʜᴀᴛs ᴏɴ {Hiroko.mention}.")
    else:
        await mystic.edit_text(
